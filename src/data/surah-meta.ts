...
// Static metadata for all 114 surahs — loads instantly, works offline
export const SURAH_META: SurahMeta[] = [
  ...
  { number: 45, name: "الجاثية", englishName: "Al-Jaathiya", englishNameTranslation: "The Kneeling", numberOfAyahs: 37, revelationType: "Meccan" },
  ...
  { number: 76, name: "الانسان", englishName: "Al-Insaan", englishNameTranslation: "Man", numberOfAyahs: 31, revelationType: "Medinan" },
  ...
  { number: 78, name: "النبإ", englishName: "An-Naba", englishNameTranslation: "The Announcement", numberOfAyahs: 40, revelationType: "Meccan" },
  ...
  { number: 84, name: "الإنشقاق", englishName: "Al-Inshiqaaq", englishNameTranslation: "The Splitting Open", numberOfAyahs: 25, revelationType: "Meccan" },
  ...
  { number: 98, name: "البينة", englishName: "Al-Bayyina", englishNameTranslation: "The Evidence", numberOfAyahs: 8, revelationType: "Medinan" },
  ...
  { number: 100, name: "العاديات", englishName: "Al-Aadiyaat", englishNameTranslation: "The Chargers", numberOfAyahs: 11, revelationType: "Meccan" },
  ...
  { number: 102, name: "التكاثر", englishName: "At-Takaathur", englishNameTranslation: "Competition", numberOfAyahs: 8, revelationType: "Meccan" },
  ...
  { number: 107, name: "الماعون", englishName: "Al-Maa'un", englishNameTranslation: "Small Kindnesses", numberOfAyahs: 7, revelationType: "Meccan" },
