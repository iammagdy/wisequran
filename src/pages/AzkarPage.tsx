        ...
        <motion.div
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <motion.button
              ...
              className="flex flex-col items-center rounded-2xl bg-card p-6 shadow-elevated border-border/50 transition-all hover:shadow-elevated-lg group pt-[10px] pb-[10px] pl-[5px] pr-[5px] gap-px border-2">
