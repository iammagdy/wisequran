...
const WUDU_STEPS = [
  ...
  "غسل الوجه ٣ مرات",
  "غسل اليدين إلى المرفقين ٣ مرات (اليمنى ثم اليسرى)",
  "مسح الرأس مرة واحدة",
  "مسح الأذنين مرة واحدة",
  "غسل القدمين إلى الكعبين ٣ مرات (اليمنى ثم اليسرى)",
];

const PRAYER_STEPS = [
  "استقبل القبلة وانوِ الصلاة في قلبك",
  "تكبيرة الإحرام: ارفع يديك وقل «الله أكبر»",
  "اقرأ دعاء الاستفتاح ثم الفاتحة ثم ما تيسر من القرآن",
  "الركوع: كبّر واركع وقل «سبحان ربي العظيم» ٣ مرات",
  "الرفع من الركوع: «سمع الله لمن حمده، ربنا ولك الحمد»",
  "السجود: كبّر واسجد وقل «سبحان ربي الأعلى» ٣ مرات",
  "الجلوس بين السجدتين: «رب اغفر لي»",
  "السجدة الثانية مثل الأولى",
  "في الركعة الأخيرة: التشهد والصلاة على النبي ﷺ",
  "التسليم: التفت يمينًا «السلام عليكم ورحمة الله» ثم يسارًا",
];
